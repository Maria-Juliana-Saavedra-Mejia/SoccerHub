  ...
  getDefaultData() {
    ...
    const players = [
      ...
      // ================= ATLÉTICO MADRID =================
      {
        ...
        name: "Jan Oblak",
        position: "Goalkeeper",
        imageUrl:"https://assets-us-01.kc-usercontent.com/31dbcbc6-da4c-0033-328a-d7621d0fa726/44b82186-03cf-49d5-85ab-e140e98ab4f1/2024-11-23T153816Z_1165472192_UP1EKBN17FRIR_RTRMADP_3_SOCCER-SPAIN-ATM-ALA-REPORT.JPG?ver=03-06-2025?w=3840&q=75",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Nahuel Molina",
        position: "Right Back",
        imageUrl:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtHXvFlaAt9PuQyH28ibGUZklfIjN60UtyRQ&s",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "José Giménez",
        position: "Center Back",
        imageUrl:"https://img-estaticos.atleticodemadrid.com/system/fotos/16559/destacado_600x600/BUSTOS_WEB_900x900_0001_2_J-M-GIMENEZ.png?1723912577",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Reinildo",
        position: "Left Back",
        imageUrl:"https://ichef.bbci.co.uk/ace/standard/1024/cpsprodpb/c019/live/403b36e0-5c10-11f0-af65-4b31fe04415f.jpg",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Koke",
        position: "Midfielder",
        imageUrl:"https://assets.laliga.com/squad/2025/t175/p77390/2048x2225/p77390_t175_2025_1_001_000.png",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
      ...
      },
      {
        ...
        position: "Forward",
        imageUrl:"https://www.reuters.com/resizer/v2/E2DIJ5JJLFOUJDZA7BLHQFHUEY.jpg?auth=1e71ad49361bc03954f989739bb7bfa7f5c8789685c634418c44ab9810555f0d&width=1920&quality=80",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Álvaro Morata",
        position: "Striker",
        imageUrl:"https://www.football-espana.net/wp-content/uploads/2022/10/Alvaro-Morata.jpg",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Samuel Lino",
        position: "Forward",
        imageUrl:"https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Samuel_Lino%2C_FC_Salzburg_vs._Atletico_Madrid_%282025-01-29_UEFA_Championsleague%29_83_%28cropped%29.jpg/960px-Samuel_Lino%2C_FC_Salzburg_vs._Atletico_Madrid_%282025-01-29_UEFA_Championsleague%29_83_%28cropped%29.jpg",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Memphis Depay",
        position: "Forward",
        imageUrl:"https://a.espncdn.com/photo/2024/0910/r1384469_1296x729_16-9.jpg",
      },
      {
        id: SoccerHubUtils.newId(),
        teamId: atletico,
        name: "Axel Witsel",
        position: "Midfielder",
        imageUrl:"https://imageio.forbes.com/specials-images/imageserve/640e794eab26dbc3159ef8a0/Real-Madrid-v-Atletico-Madrid---Spanish-Copa-del-Rey/0x0.jpg?format=jpg&width=480",
      },
    ];
